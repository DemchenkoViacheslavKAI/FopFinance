...
namespace FopFinance.Storage
{
    ...
    public static class DataStorage
    {
        ...
        public static (Entrepreneur, List<Income>, List<Expense>, List<Category>)
            LoadFromJSON(string path)
        {
            ...
            return (data.Entrepreneur, data.Incomes, data.Expenses, data.Categories);
        }
        ...
        private static List<Income> DeserializeIncomes(XElement? el)
        {
            ...
            foreach (var xe in el.Elements("Income"))
                list.Add(new Income
                {
                    ...
                    Amount      = decimal.TryParse(xe.Element("Amount")?.Value, out decimal a) ? a : 0,
